...
<div class="flex justify-center max-w-lg mx-auto">
  <table class="table-auto w-full">
    ...
    <tbody>
      <tr>
        <td class="w-1/2">Left Brain</td>
        <td class="w-1/2">Right Brain</td>
      </tr>
      <tr>
        <td class="w-1/2">Deterministic</td>
        <td class="w-1/2">Probabilistic</td>
      </tr>
      <tr>
        <td class="w-1/2">Objective</td>
        <td class="w-1/2">Subjective</td>
      </tr>
      <tr>
        <td class="w-1/2">MS Excel</td>
        <td class="w-1/2">ChatGPT</td>
      </tr>
      <tr>
        <td class="w-1/2">Adobe Photoshop</td>
        <td class="w-1/2">Stable Diffusion</td>
      </tr>
      <tr>
        <td class="w-1/2">Math and Logic</td>
        <td class="w-1/2">Language and Images</td>
      </tr>
      <tr>
        <td class="w-1/2">CPU</td>
        <td class="w-1/2">GPU</td>
      </tr>
    </tbody>
  </table>
</div>
...
<img
  ...
  class="w-full max-w-lg h-auto mx-auto"
/>
