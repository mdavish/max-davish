...
image: /blog/future-of-software.png
---
...
<div className="text-center text-sm text-gray-700 not-prose mb-8">
...
In our work at Quotient, we leverage all three of these techniques, and in fact
multi-agent collaboration is foundational to our agent framework.
    ...
    <thead>
      <tr>
        ...
        <th>
          ...
          <p className="text-sm font-normal text-gray-600">1980 — 2020</p>
        </th>
        <th>
          <span className="text-lg font-medium">Software 2.0</span>
          <p className="text-sm font-normal text-gray-600">2020 and beyond</p>
        </th>
      </tr>
    </thead>
    <tbody>
